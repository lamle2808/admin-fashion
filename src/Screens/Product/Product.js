        ...
        <Box height="80vh" width="99%">
          <DataGrid
            ...
            rows={tags.map((item) => ({
              ...
              category: item.category ? item.category.categoryName : 'Không xác định',
              brand: item.brand ? item.brand.name : 'Không xác định',
          ...
          >
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: "5px 5px 15px" }}>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'flex-end', mb: 2 }}>
                <Button variant="contained" color="success" sx={{ mr: 2 }} onClick={() => setOpenCategoryModal(true)}>
                  Quản lý danh mục
                </Button>
                <Button variant="contained" color="success" onClick={() => navigate('/ImportOrder')}>
                  TẠO PHIẾU NHẬP HÀNG
                </Button>
              </Box>
            </Box>
